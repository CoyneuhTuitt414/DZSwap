...
contract DzPool is Ownable {
    ...
    function deposit(
        ...
        _deposit(_msgSender(), tid, amount);
    }
    ...
    function active(address r) public payable {
...
contract XLock {
    ...
    function unlock(address xToken) public {
        require(_root == msg.sender, "XLock: Require root");
        require(block.timestamp >= _unlockTime, "XLock: Already lock");
